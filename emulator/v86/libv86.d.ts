...
declare class V86Starter {
  ...
  add_listener<T extends keyof V86StarterEventParams>(
    event: T,
    fn: (arg: V86StarterEventParams[T]) => void
  ): void;
  remove_listenerr<T extends keyof V86StarterEventParams>(
    event: T,
    fn: (arg: V86StarterEventParams[T]) => void
  ): void;
  ...
  read_file(
    file: string,
    callback: (err: Object, data: Uint8Array) => void
  ): void;
