...
rm os.img
dd if=/dev/zero of=os.img bs=32K count=512
...
printf '\1f' | dd of=os.img bs=1 seek=453 count=1 conv=notrunc
# LBA -> 4 bytes at 0x1cA, 4 bytes at 0x7e20
printf '\x00\x80\x00\x00' | dd of=os.img bs=1 seek=458 count=4 conv=notrunc
printf '\x00\x80\x00\x00' | dd of=os.img bs=1 seek=32288 count=4 conv=notrunc
