...
import { WS_VISIBLE, WS_CHILD, WS_EX_CLIENTEDGE, EN_CHANGE, WM_COMMAND, HIWORD } from '../emulator95/constants';
...
export function Edit({
  ...
  return (
    <w95Window ref={editRef} type='Edit' params={WS_VISIBLE | WS_CHILD | params} extStyle={WS_EX_CLIENTEDGE} x={x} y={y} w={w} h={h} onEvent={handleEvent}>
      {children}
    </w95Window>
  );
}
